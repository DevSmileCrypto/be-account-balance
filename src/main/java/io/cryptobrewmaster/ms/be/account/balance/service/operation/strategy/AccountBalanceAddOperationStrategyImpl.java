...
@Component
public class AccountBalanceAddOperationStrategyImpl implements AccountBalanceOperationStrategy {
    ...
    public void handleOperation(AccountBalanceOperation accountBalanceOperation) {
        ...
        var newQuantity = oldQuantity.add(BigDecimal.valueOf(accountBalanceOperation.getQuantity()));

        var accountBlockedBalance = AccountBlockedBalanceConverter.toEntity(
                oldQuantity, BlockedBalanceStatus.IN_PROCESS, Operation.ADD, accountBalance, accountBalanceOperation
        );
    ...
    public BalanceOperationType getOperationType() {
        return BalanceOperationType.ADD;
    }
}
